...
const metasprite_t sprite_elephant_metasprite_1[]  = {
    { -10, 26, 32, 1 }, { 10, -50, 34, 1 }, { 0, 42, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};

const metasprite_t sprite_elephant_metasprite_2[]  = {
    { 0, -25, 36, 1 }, { -10, 51, 38, 1 }, { 10, -8, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};

const metasprite_t sprite_elephant_metasprite_3[]  = {
    { -10, 26, 40, 1 }, { 10, -53, 42, 1 }, { 0, 45, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};

const metasprite_t sprite_elephant_metasprite_4[]  = {
    { -10, 26, 44, 1 }, { 10, -53, 46, 1 }, { 0, 45, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};

const metasprite_t sprite_elephant_metasprite_5[]  = {
    { -10, 26, 32, 1 }, { 10, -52, 42, 1 }, { 0, 44, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};

const metasprite_t sprite_elephant_metasprite_6[]  = {
    { -10, 26, 38, 1 }, { 10, -50, 36, 1 }, { 0, 42, 2, 1 }, { -16, 0, 4, 1 }, { -16, 0, 6, 1 }, { 32, -8, 8, 1 }, { -16, 0, 10, 1 }, { -16, 0, 12, 1 }, { 32, -8, 14, 1 }, { -16, 0, 10, 33 }, { -16, 0, 16, 1 }, { 32, -8, 18, 1 }, { -16, 0, 20, 1 }, { -16, 0, 22, 1 }, { 16, -8, 24, 1 }, { -16, 0, 26, 1 }, { 16, -8, 30, 1 }, { -16, 0, 6, 33 },
    {metasprite_end}
};
